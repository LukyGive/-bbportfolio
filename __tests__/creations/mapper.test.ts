...
const row = {
  id: '7c00c69f-5b12-4eed-b981-e969221a1fd2', slug: 'vorakh', name: 'Vorakh', category: 'Boss', tags: ['Ice'],
  description: 'Boss', animations: ['Idle'], featured: true, featured_order: 1, published: true,
  created_at: '2026-09-20', updated_at: '2026-09-20T00:00:00Z', software: 'Blockbench', model_type: 'Entity',
  version: null, notes: null, cover_image_path: '7c00/cover.webp', bbmodel_path: '7c00/vorakh.bbmodel',
  bbmodel_filename: 'vorakh.bbmodel', bbmodel_size: 123,
  creation_images: [
